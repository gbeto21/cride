    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verified', models.BooleanField(default=False, help_text='Verified circles ara also know as official communities.', verbose_name='verified circle')),
                ...
                ('members_limit', models.PositiveIntegerField(default=0, help_text='If cicle is limited, this will be the limit on the number of members.')),
            ],
            options={
